...
from .constants import TorrentStatus, TorrentStat
...
class QbittorrentMetricsCollector:
    ...
    def get_status_metrics(self):
        ...
        return [
            ...
            {
                "name": "qbittorrent_download_bytes_total",
            ...
            {
                "name": "qbittorrent_upload_bytes_total",
    ...
    def get_torrent_metrics(self):
        ...
        for torrent in torrents:
            ...
            metrics.append(
                {
                    "name": "qbittorrent_tracker_torrent_upload_bytes_total",
                    "type": "counter",
            ...
            metrics.append(
                {
                    "name": "qbittorrent_tracker_torrent_download_bytes_total",
                    "type": "counter",
        ...
        for t, count in counter.items():
            metrics.append(
                {
                    "name": "qbittorrent_torrents_count",
                    "value": count,
                    "labels": {
                        "status": t.status,
                        "category": t.category,
